          ...
          <div className="mt-6 space-y-6 text-sm">
            <label className="block">
              ...
              <input
                ...
                className="mt-2 w-full border border-zinc-300 bg-white px-4 py-3 text-sm text-black transition-all duration-200 outline-none focus:border-orange-600 focus:ring-1 focus:ring-orange-600"
              />
            </label>
            <label className="block">
            ...
            <div className="flex flex-col gap-3 sm:flex-row">
              ...
              <motion.button
                ...
                whileHover={{ y: -1 }}
                whileTap={{ scale: 0.98 }}
                className="flex-1 bg-orange-600 px-5 py-3 text-sm font-bold uppercase tracking-[0.08em] text-white transition-all duration-200 hover:bg-black"
              >
                Confirmar datos
              </motion.button>
            </div>
        ...
        <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} className="mt-6 border border-zinc-200 bg-white p-5 sm:p-6 lg:p-7 text-black shadow-sm">
          ...
          <div className="mt-6 space-y-6 text-sm">
                    ...
                    <label className="block">
                      ...
                      <div className="mt-3 grid grid-cols-2 gap-3">
                        <input
                          ...
                          className="w-2/3 border border-zinc-300 bg-white px-4 py-3 text-sm text-black transition-all duration-200 outline-none focus:border-orange-600 focus:ring-1 focus:ring-orange-600"
                        />
                        <input
                          type="text"
                          placeholder="CVC"
                          ...
                          className="w-1/2 border border-zinc-300 bg-white px-4 py-3 text-sm text-black transition-all duration-200 outline-none focus:border-orange-600 focus:ring-1 focus:ring-orange-600"
                        />
                      </div>
                    </label>
                  </div>
            ...
            {paymentInfo.paymentMethod === 'paypal' && (
              <p className="border-l-4 border-orange-600 bg-zinc-50 px-4 py-3 text-sm text-zinc-700">Serás redirigido a PayPal tras confirmar.</p>
            )}

            {paymentInfo.paymentMethod === 'cash' && (
              <p className="border-l-4 border-orange-600 bg-zinc-50 px-4 py-3 text-sm text-zinc-700">Pagarás al recibir el pedido.</p>
            )}
