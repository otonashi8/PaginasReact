...
export const Footer = () => {
  ...
  const socialLinks = (
    <>
      <a
        href="https://www.tiktok.com/@3x100.pe?_r=1"
        target="_blank"
        rel="noreferrer"
        className="inline-flex w-full justify-center items-center gap-2 rounded-full border border-white/20 bg-black px-4 py-2 text-sm font-medium text-white transition hover:border-orange-600 hover:bg-orange-600"
      >
      ...
      <a
        href="https://www.instagram.com/3x100.pe/#"
        target="_blank"
        rel="noreferrer"
        className="inline-flex w-full justify-center items-center gap-2 rounded-full border border-white/20 bg-pink-700 px-4 py-2 text-sm font-medium text-white transition hover:border-orange-600 hover:bg-orange-600"
      >
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
      ...
      <a
        href="https://www.facebook.com/people/3X100/61584965300866/"
        target="_blank"
        rel="noreferrer"
        className="inline-flex w-full justify-center items-center gap-2 rounded-full border border-white/20 bg-blue-500 px-4 py-2 text-sm font-medium text-white transition hover:border-orange-600 hover:bg-orange-600"
      >
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
    ...
    <footer className="border-t border-zinc-200 bg-white text-black">
            ...
            <div className="mt-10 space-y-5 lg:hidden">
                ...
                <AnimatePresence initial={false}>
                  {openSection === "empresa" && (
                    <motion.ul
                      ...
                      className="overflow-hidden mt-4 space-y-3 text-left text-sm text-black/80"
                    >
                      {aboutLinks.map((link) => (
                        <li key={link.href}>
                          <Link
              ...
              <div className="border-t border-black/10 pt-4">
                ...
                <button
                  ...
                  className="flex w-full items-center justify-between text-sm text-black/80 uppercase tracking-[0.2em]"
                >
              ...
              <div className="border-t border-white/10 pt-4">
                ...
                <AnimatePresence initial={false}>
                  {openSection === "redes" && (
                    ...
                    >
                      <li>
                        <a href="https://www.tiktok.com/@3x100.pe?_r=1" target="_blank" rel="noreferrer" className="block rounded-lg px-2 py-2 transition hover:bg-white/10">
                          TikTok
                        </a>
                      </li>
                      <li>
                        <a href="https://www.instagram.com/3x100.pe/#" target="_blank" rel="noreferrer" className="block rounded-lg px-2 py-2 transition hover:bg-white/10">
                          Instagram
                        </a>
                      </li>
                      <li>
                        <a href="https://www.facebook.com/people/3X100/61584965300866/" target="_blank" rel="noreferrer" className="block rounded-lg px-2 py-2 transition hover:bg-white/10">
                          Facebook
                        </a>
                      </li>
                    </motion.ul>
      ...
      <div className="border-t border-white/10 bg-black/90">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-3 px-6 py-4 text-sm text-white/60 sm:flex-row lg:px-8">
          ...
          <p>© 2026 3X100. Todos los derechos reservados.</p>
