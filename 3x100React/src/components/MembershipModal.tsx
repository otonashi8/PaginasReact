          ...
          >
            <div className="flex flex-col gap-6 border-b border-white/10 pb-7 lg:flex-row lg:items-center lg:justify-between">
              ...
              <button
                type="button"
                onClick={onClose}
                className="self-end border border-white/10 bg-[#1A1A1A] px-4 py-2 text-sm font-medium text-white transition hover:border-orange-600 hover:text-orange-500"
              >
                X
              </button>
            </div>
            ...
            <div className="mt-8 grid gap-5 lg:grid-cols-[0.9fr_1.1fr]">
              ...
              <div className="sticky top-0 border border-white/10 bg-[#111111] p-7">
                <div className="space-y-2">
                  <div className="flex h-12 w-12 items-center justify-center border border-orange-600/30 bg-orange-600/10">
            ...
            <div className="mt-8 flex flex-col gap-5 border-t border-white/10 pt-6 lg:flex-row lg:items-center lg:justify-between">
              ...
              <motion.button
                ...
                whileHover={{ y: -1 }}
                whileTap={{ scale: 0.98 }}
                className="border border-orange-600 bg-orange-600 px-6 py-3 text-sm font-semibold uppercase tracking-[0.15em] text-white transition hover:bg-orange-500"
              >
        ...
        >
            ...
            {['plan', 'account', 'payment', 'success'].map((step, index) => {
              ...
              return (
                <motion.div
                  key={step}
                  whileHover={{ y: -1 }}
                  className={`flex flex-col items-center justify-center gap-3 border px-4 py-4 text-xs uppercase tracking-[0.15em] transition-all duration-300 ${isActive ? 'border-orange-600 bg-[#151515] text-white shadow-[0_0_35px_rgba(220,38,38,.18)]' : isCompleted ? 'border-orange-600 bg-orange-600 text-white' : 'border-white/10 bg-[#1A1A1A] text-white hover:border-orange-600/60'}`}
                >
            ...
            <motion.div key="plan" initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -8 }} className="mt-6 grid grid-cols-1 gap-5 xl:grid-cols-[1.2fr_0.8fr]">
                ...
                {plans.map((plan) => {
                  ...
                  return (
                    <motion.button
                      ...
                      className={`border p-6 text-left transition-all duration-300 ${isSelected ? 'border-orange-600 bg-[#151515] text-white shadow-[0_0_35px_rgba(220,38,38,.18)]' : 'border-black/10 bg-white text-black hover:border-black/30'}`}
                    >
                      <div className="flex items-start justify-between">
                        <div className="space-y-2">
                          <div className="flex h-12 w-12 items-center justify-center border border-orange-600/30 bg-orange-600/10 text-2xl">
                            {plan.icono}
                          </div>
                      ...
                      <div className="mt-4 flex items-end justify-between">
                        <div>
                          ...
                          <p className="mt-2 text-xs uppercase tracking-[0.18em] text-orange-500">{plan.descuento}% de descuento</p>
                        </div>
              ...
              <div className="sticky top-0 border border-white/10 bg-[#111111] p-7">
                <div className="flex items-start justify-between">
                  ...
                  <div className="border border-orange-600 bg-orange-600 px-3 py-1 text-xs font-semibold uppercase tracking-[0.18em] text-white">
                ...
                <motion.button
                  ...
                  whileHover={{ y: -1 }}
                  whileTap={{ scale: 0.99 }}
                  className="mt-8 w-full border border-orange-600 bg-orange-600 py-3 text-sm font-semibold uppercase tracking-[0.16em] text-white transition hover:bg-orange-500"
                >
                  Continuar al pago
                </motion.button>
                </PermissionGate>
            ...
            <motion.form key="account" initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -8 }} className="mt-8 grid grid-cols-1 gap-8 border border-white/10 bg-[#111111] p-7 lg:grid-cols-[1fr_1fr]" onSubmit={handleRegisterSubmit}>
              <div className="space-y-5 border-r border-white/10 pr-0 lg:pr-8">
                <label className="block text-sm text-white/70 uppercase tracking-[0.12em]">
                  ...
                  <input name="username" value={registerForm.username} onChange={handleRegisterChange} className="w-full border border-white/10 bg-[#1A1A1A] px-4 py-3 text-sm text-white placeholder:text-white/30 outline-none transition-all duration-300 focus:border-orange-600" placeholder="Tu usuario" required />
                </label>
                <label className="block text-sm text-white/70 uppercase tracking-[0.12em]">
                  <span className="mb-1 block font-medium">Correo</span>
                  <input name="email" type="email" value={registerForm.email} onChange={handleRegisterChange} className="w-full border border-white/10 bg-[#1A1A1A] px-4 py-3 text-sm text-white placeholder:text-white/30 outline-none transition-all duration-300 focus:border-orange-600" placeholder="correo@empresa.com" required />
                </label>
                <label className="block text-sm text-white/70 uppercase tracking-[0.12em]">
                  <span className="mb-1 block font-medium">Teléfono</span>
                  <input name="phone" value={registerForm.phone} onChange={handleRegisterChange} className="w-full border border-white/10 bg-[#1A1A1A] px-4 py-3 text-sm text-white placeholder:text-white/30 outline-none transition-all duration-300 focus:border-orange-600" placeholder="987654321" required />
                </label>
                <label className="block text-sm text-white/70 uppercase tracking-[0.12em]">
                  <span className="mb-1 block font-medium">RUC (opcional)</span>
                  <input name="ruc" value={registerForm.ruc || ''} onChange={handleRegisterChange} className="w-full border border-white/10 bg-[#1A1A1A] px-4 py-3 text-sm text-white placeholder:text-white/30 outline-none transition-all duration-300 focus:border-orange-600" placeholder="20600000000" />
                </label>
              </div>
              ...
              <div className="space-y-5 border-r border-white/10 pr-0 lg:pr-8">
                <label className="block text-sm text-white/70 uppercase tracking-[0.12em]">
                  ...
                  <input name="password" type="password" value={registerForm.password} onChange={handleRegisterChange} className="w-full border border-white/10 bg-[#1A1A1A] px-4 py-3 text-sm text-white placeholder:text-white/30 outline-none transition-all duration-300 focus:border-orange-600" placeholder="••••••••" required />
                </label>
                <label className="block text-sm text-white/70 uppercase tracking-[0.12em]">
                  <span className="mb-1 block font-medium">Confirmar contraseña</span>
                  <input name="confirmPassword" type="password" value={registerForm.confirmPassword} onChange={handleRegisterChange} className="w-full border border-white/10 bg-[#1A1A1A] px-4 py-3 text-sm text-white placeholder:text-white/30 outline-none transition-all duration-300 focus:border-orange-600" placeholder="••••••••" required />
                </label>
                <label className="block text-sm text-white/70 uppercase tracking-[0.12em]">
                  <span className="mb-1 block font-medium">Método de pago</span>
                  <select name="paymentMethod" value={paymentForm.paymentMethod} onChange={handlePaymentChange} className="w-full border border-white/10 bg-[#1A1A1A] px-4 py-3 text-sm text-white placeholder:text-white/30 outline-none transition-all duration-300 focus:border-orange-600">
                ...
                <label className="flex flex-col gap-4 border border-white/10 bg-[#181818] p-5 lg:flex-row lg:items-center lg:justify-between">
                  ...
                  <select name="autoRenew" value={String(registerForm.autoRenew)} onChange={handleRegisterChange} className="w-full border border-white/10 bg-[#1A1A1A] px-4 py-3 text-sm text-white outline-none focus:border-orange-600">
              ...
              {error ? <p className="text-sm text-orange-600 lg:col-span-2">{error}</p> : null}

              <div className="flex flex-col gap-3 sm:flex-row lg:col-span-2">
                <motion.button whileHover={{ y: -1 }} whileTap={{ scale: 0.98 }} type="button" onClick={() => setFlowStep('plan')} className="flex-1 rounded-full border border-white/10 bg-[#1A1A1A] px-4 py-3 text-sm font-medium text-white uppercase tracking-[0.16em]/5">
                  Volver
                </motion.button>
                <PermissionGate permission={PERMISSIONS.subscriptionCreate}>
                <motion.button whileHover={{ y: -1 }} whileTap={{ scale: 0.98 }} type="submit" className="flex-1 rounded-full bg-orange-600 uppercase tracking-[0.16em] px-4 py-3 text-sm font-semibold text-white transition hover:bg-orange-600">
                  Continuar
                </motion.button>
                </PermissionGate>
              </div>
          ...
          {flowStep === 'payment' ? (
            <motion.form key="payment" initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -8 }} className="mt-8 border border-white/10 bg-[#111111] p-7" onSubmit={handlePaymentSubmit}>
              <div className="space-y-5 border-r border-white/10 pr-0 lg:pr-8">
                ...
                {paymentForm.paymentMethod === 'card' ? (
                  <div className="space-y-4 rounded-[1.2rem] border border-white/10 bg-[#1A1A1A] p-4">
                    <label className="block text-sm text-white/70 uppercase tracking-[0.12em]">
                      ...
                      <input name="cardNumber" value={paymentForm.cardNumber} onChange={handlePaymentChange} className="w-full border border-white/10 bg-[#1A1A1A] px-4 py-3 text-sm text-white placeholder:text-white/30 outline-none transition-all duration-300 focus:border-orange-600" placeholder="4242 4242 4242 4242" required />
                    </label>
                    <div className="grid gap-4 grid-cols-1 sm:grid-cols-2">
                      <label className="block text-sm text-white/70 uppercase tracking-[0.12em]">
                        <span className="mb-1 block font-medium">Nombre en la tarjeta</span>
                        <input name="cardName" value={paymentForm.cardName} onChange={handlePaymentChange} className="w-full border border-white/10 bg-[#1A1A1A] px-4 py-3 text-sm text-white placeholder:text-white/30 outline-none transition-all duration-300 focus:border-orange-600" placeholder="Juan Pérez" required />
                      </label>
                      <label className="block text-sm text-white/70 uppercase tracking-[0.12em]">
                ...
                {paymentForm.paymentMethod === 'yape' ? (
                  <label className="block text-sm text-white/70 uppercase tracking-[0.12em]">
                    ...
                    <input name="yapePhone" value={paymentForm.yapePhone} onChange={handlePaymentChange} className="w-full border border-white/10 bg-[#1A1A1A] px-4 py-3 text-sm text-white placeholder:text-white/30 outline-none transition-all duration-300 focus:border-orange-600" placeholder="987654321" required />
                  </label>
                ) : null}
              ...
              <div className="mt-6 flex flex-col gap-3 sm:flex-row">
                <motion.button whileHover={{ y: -1 }} whileTap={{ scale: 0.98 }} type="button" onClick={() => setFlowStep(isAuthenticated ? 'plan' : 'account')} className="flex-1 rounded-full border border-white/10 bg-[#1A1A1A] px-4 py-3 text-sm font-medium text-white transition hover:bg-orange-600 uppercase tracking-[0.16em]/5">
                  Volver
                </motion.button>
                <PermissionGate permission={PERMISSIONS.subscriptionCreate}>
                <motion.button whileHover={{ y: -1 }} whileTap={{ scale: 0.98 }} type="submit" disabled={isSubmitting} className="flex-1 rounded-full bg-black px-4 py-3 text-sm font-semibold text-white transition hover:bg-orange-600 disabled:cursor-not-allowed disabled:bg-orange-600 uppercase tracking-[0.16em]/70">
          ...
          {flowStep === 'success' ? (
            <motion.div key="success" initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -8 }} className="mt-8 border border-white/10 bg-[#111111] p-7">
              ...
              <motion.button whileHover={{ y: -2 }} whileTap={{ scale: 0.98 }} type="button" onClick={handleComplete} className="mt-8 flex w-full items-center justify-center border border-orange-600 bg-orange-600 px-6 py-4 text-sm font-semibold uppercase tracking-[0.18em] text-white transition hover:bg-orange-700">
                Volver al inicio
              </motion.button>
            </motion.div>
          ) : null}
