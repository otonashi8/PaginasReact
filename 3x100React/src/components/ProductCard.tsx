    ...
    return (
        ...
        >
            ...
            <div className="flex flex-1 flex-col">
                ...
                <span className="mt-1 font-semibold text-orange-600">
                    S/{product.price}
                </span>
            </div>
        </Link>
    ...
    >
      ...
      <div className="mt-4 flex items-start justify-between gap-3">
        ...
        <button
          ...
          className={`rounded-full border p-2 transition ${isFavorite ? 'border-black-600 bg-orange-600 text-white' : 'border-black/10 text-black hover:border-orange-600 hover:text-orange-600'}`}
        >
          <Heart size={16} />
        </button>
        </PermissionGate>
      ...
      <div className="mt-4 flex items-center justify-between">
        <div>
          ...
          <p className="text-base font-semibold text-orange-600">S/{product.price}</p>
        </div>
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="rounded-full border border-black/10 p-2 text-black transition hover:border-orange-600 hover:text-orange-600"
          >
            <Plus size={16} />
          </button>
          </PermissionGate>
          ...
          {onQuickAdd ? (
            <button
              ...
              className="rounded-full border border-black/10 px-3 py-2 text-sm font-medium text-black transition hover:border-orange-600 hover:text-orange-600"
            >
              Ver
            </button>
          ) : null}
