      ...
      <div className="grid gap-5 lg:grid-cols-[1.08fr_0.92fr] lg:gap-6">
        <div className="rounded-[1.8rem] border border-black/10 bg-white p-5 shadow-[0_12px_34px_rgba(0,0,0,0.05)] sm:p-7">
          ...
          <div className="mt-6 space-y-3 text-sm text-black/70">
            <div className="rounded-[1.1rem] border border-black/10 bg-white p-4 transition-all duration-200 hover:-translate-y-0.5 hover:border-orange-600/40 hover:shadow-[0_8px_20px_rgba(0,0,0,0.06)]">
        ...
        <div className="rounded-[1.8rem] border border-black/10 bg-white p-5 shadow-[0_12px_34px_rgba(0,0,0,0.05)] sm:p-7">
          ...
          <div className="mt-6 space-y-3 rounded-[1.25rem] border border-black/10 bg-white p-4 sm:p-5">
            <a href="tel:+51929370461" className="inline-flex w-full items-center justify-center gap-2 rounded-xl border border-black/15 bg-white px-4 py-3 text-sm font-medium text-black transition-colors hover:border-orange-600 hover:text-orange-600 sm:justify-start">
              <Phone size={16} /> +51 929370461
            </a>
            <a href="mailto:contacto@3x100.com" className="inline-flex w-full items-center justify-center gap-2 rounded-xl border border-black/15 bg-white px-4 py-3 text-sm font-medium text-black transition-colors hover:border-orange-600 hover:text-orange-600 sm:justify-start">
              <Mail size={16} /> contacto@3x100.com
            </a>
        ...
        <div className="rounded-[1.8rem] border border-black/10 bg-white p-5 shadow-[0_12px_34px_rgba(0,0,0,0.05)] sm:p-7">
          ...
          <div className="mt-6 rounded-[1.3rem] border border-black/10 bg-white p-4 sm:p-5">
            ...
            <div className="mt-4 space-y-3">
              <input className="w-full rounded-xl border border-black/15 bg-white px-4 py-3 text-sm text-black outline-none transition-colors focus:border-orange-600" placeholder="Tu nombre" />
              <input className="w-full rounded-xl border border-black/15 bg-white px-4 py-3 text-sm text-black outline-none transition-colors focus:border-orange-600" placeholder="Tu negocio o marca" />
              <PermissionGate permission={PERMISSIONS.affiliateCreate}>
              <button type="button" className="w-full rounded-xl border border-black bg-black px-5 py-3 text-sm font-semibold uppercase tracking-[0.12em] text-white transition-colors duration-200 hover:border-orange-600 hover:bg-orange-600">
              ...
              <button
                ...
                className="w-full rounded-xl border border-black/20 bg-white px-5 py-3 text-sm font-semibold uppercase tracking-[0.12em] text-black transition-colors duration-200 hover:border-orange-600 hover:text-orange-600"
              >
                Benefíciate
              </button>
              </PermissionGate>
