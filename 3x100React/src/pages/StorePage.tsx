                ...
                >
                  <div className="flex items-center justify-between gap-3 border-b border-black/8 pb-3">
                    ...
                    <button
                      ...
                      className="inline-flex h-9 w-9 items-center justify-center rounded-sm border border-black/10 text-black transition hover:border-orange-600 hover:text-orange-600"
                  ...
                  <div className="mt-4 grid grid-cols-2 gap-2 border-t border-black/8 pt-3">
                    ...
                    <button
                      ...
                      className="rounded-sm border border-black bg-black px-4 py-2.5 text-xs font-semibold uppercase tracking-[0.16em] text-white transition duration-300 hover:border-orange-600 hover:bg-orange-600"
                    >
                      Aplicar filtros
                    </button>
                  </div>
                  ...
                  {paginatedProducts.map((product, index) => {
                    ...
                    return (
                      <motion.article
                        ...
                        whileHover={{ y: -8 }}
                        className="group flex h-full flex-col overflow-hidden rounded-sm border border-black/8 bg-white shadow-[0_12px_35px_rgba(0,0,0,0.04)] transition duration-300 hover:border-orange-900/20 hover:shadow-[0_24px_60px_rgba(0,0,0,0.12)]"
                      >
                        ...
                        <div className="flex flex-1 flex-col gap-5 p-5">
                          <div className="flex items-start justify-between gap-4">
                            ...
                            <PermissionGate permission={PERMISSIONS.productUpdate}>
                              ...
                              className={`inline-flex h-10 w-10 items-center justify-center rounded-sm border transition duration-300 ${isFavorite ? 'border-orange-600 bg-orange-600 text-white shadow-[0_10px_22px_rgba(193,18,31,0.18)]' : 'border-black/10 bg-white text-black hover:border-orange-600/30 hover:bg-orange-50 hover:text-orange-600'}`}
                          ...
                          <div className="mt-auto flex flex-col gap-4 border-t border-black/6 pt-4 sm:flex-row sm:items-end sm:justify-between">
                                ...
                                <p className="text-2xl font-semibold tracking-[-0.04em] text-black"> 
                                    <PriceDisplay product={product}/>
                                      {hayDescuento && etiquetaDescuento ? (
                                        <span className="rounded-full bg-orange-50 px-3 py-1 text-xs font-semibold uppercase tracking-[0.16em] text-orange-600">
                                        {etiquetaDescuento}
                                        </span>
                                      ) : null}</p>
                              </div>
                            ...
                            <button
                              ...
                              className="inline-flex w-full items-center justify-center gap-2 rounded-sm border border-black/10 bg-black px-4 py-2.5 text-xs font-semibold uppercase tracking-[0.18em] text-white transition duration-300 hover:border-orange-600 hover:bg-orange-600 sm:w-auto"
                            >
                              <ShoppingBag size={15} />
                            </button>
                            </PermissionGate>
