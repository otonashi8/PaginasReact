  ...
  return (
    <section className="space-y-8 rounded-[2rem] border border-black/10 bg-white p-6 shadow-sm sm:p-8">
      <header className="space-y-3">
        ...
        <TypewriterTitle as="h1" text="Terminos y Condiciones" className="text-3xl font-semibold uppercase tracking-[0.2em] text-black" />
        <p className="max-w-3xl text-sm leading-relaxed text-black/70 sm:text-base">
          Estos terminos son aplicables a las marcas EZZETA, MAXETA, CREPANTE, 3x100 y UOMO CATTIVO,
