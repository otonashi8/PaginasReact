...
data class Product(
    ...
    @Deprecated("Use categoryIds") val categoryId: String = "",
    val categoryIds: List<String> = emptyList(),
    @Deprecated("Use subCategoryIds") val subCategories: List<String> = emptyList(),
    ...
    fun getAvailableSizes(): List<String> {
        ...
        // Legacy fallback: usar la primera categoría disponible si no hay lista
        val catId = categoryIds.firstOrNull() ?: categoryId
        return when (catId) {
...
data class HomeBanner(
    ...
    val isActive: Boolean = true,
    val order: Int = 0,
    val rotationDurationMillis: Long = 3000L,
    val createdAt: Long = System.currentTimeMillis(),
    val updatedAt: Long = System.currentTimeMillis()
)

enum class PopupContentType {
    IMAGE, VIDEO
}
...
data class AppPopup(
    val id: String,
    val name: String,
    val triggerScreen: String, // Ruta de Screen.kt
    val contentType: PopupContentType,
    val mediaPath: String, // URL o ruta local
    val isActive: Boolean = true,
    val order: Int = 0,
    val showOncePerSession: Boolean = true,
    val actionType: PopupActionType = PopupActionType.NONE,
