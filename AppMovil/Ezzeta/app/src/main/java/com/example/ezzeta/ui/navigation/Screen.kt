...
sealed class Screen(val route: String, val title: String? = null, val icon: ImageVector? = null) {
    ...
    object AdminCustomerProductEdit : Screen("admin_customer_product_edit/{productId}") {
        fun createRoute(productId: String) = "admin_customer_product_edit/$productId"
    }
    ...
    object AdminPopups : Screen("admin_popups")
}
