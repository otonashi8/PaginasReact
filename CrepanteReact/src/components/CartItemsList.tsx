              ...
              <div className="min-w-0 flex-1">
                <div className="flex items-start justify-between gap-2">
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="p-2 text-neutral-400 transition duration-200 hover:text-red-600"
                  >
                    <Trash2 size={14} />
                  </motion.button>
                  </PermissionGate>
                ...
                <div className="mt-3 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between text-xs">
                  ...
                  <select
                    ...
                    className="min-w-[4.5rem] border border-black px-3 py-2 text-xs uppercase outline-none transition hover:border-red-600"
                  >
