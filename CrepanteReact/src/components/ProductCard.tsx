    ...
    >
      ...
      <div className="mt-4 flex items-start justify-between gap-3">
        ...
        <button
          ...
          className={`rounded-full border p-2 transition ${isFavorite ? 'border-black-600 bg-red-600 text-white' : 'border-black/10 text-black hover:border-red-600 hover:text-red-600'}`}
        >
          <Heart size={16} />
        </button>
        </PermissionGate>
