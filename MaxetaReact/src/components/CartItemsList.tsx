  ...
  return (
    <div className="space-y-5">
      {items.map((item) => {
        ...
        return (
          <motion.div key={`${item.id}-${item.size}`} layout whileHover={{ backgroundColor: '#fafafa' }} className="border-b border-black/10 bg-white py-5 transition-colors duration-200 hover:bg-neutral-50">
