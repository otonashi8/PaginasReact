  ...
  const handleQuickResponse = (type: string) => {
    switch (type) {
      ...
      case 'membership':
        ...
        break;
      case 'advisor':
        window.open('https://wa.me/51933141678?text=Hola,%20necesito%20ayuda%20en%20o3x100.', '_blank', 'noopener,noreferrer');
        break;
      default:
        break;
    }
        ...
        {isOpen && (
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-2 border-t border-white/10 p-3 sm:grid-cols-2">
              ...
              <a
                href="https://wa.me/51933141678?text=Hola,%20necesito%20ayuda%20en%20o3x100."
                target="_blank"
