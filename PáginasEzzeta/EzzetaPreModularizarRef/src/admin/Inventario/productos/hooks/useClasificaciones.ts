...
import type { ClasificacionesProductos, GuiaLavadoSubcategoria, GuiaTallasSubcategoria, NivelMayoristaSubcategoria } from '../DatosProductos';
import {
...
export const useClasificaciones = () => {
    ...
    const guardarNivelesMayoristasSubcategoria = (categoria: string, subcategoria: string, niveles: NivelMayoristaSubcategoria[]) => {
        guardarSubcategoriaMetadata(categoria, subcategoria, { nivelesMayoristas: niveles });
        recargarClasificaciones();
    };

    const guardarMetadataSubcategoria = (categoria: string, subcategoria: string, metadata: Parameters<typeof guardarSubcategoriaMetadata>[2]) => {
        guardarSubcategoriaMetadata(categoria, subcategoria, metadata);
        recargarClasificaciones();
    };
    ...
    return {
        ...
        guardarNivelesMayoristasSubcategoria,
        guardarMetadataSubcategoria,
        crearGuiaTallasBase,
    };
};
