            ...
            {loading ? (
              ...
              <tr key={trabajo.id} className="align-top hover:bg-zinc-50">
                ...
                <td className="border-b border-zinc-200 px-4 py-3 text-right">
                  <TablaAcciones>
                    <Button type="button" variant="ghost" onClick={() => onEditar(trabajo)} aria-label={`Editar ${trabajo.puesto}`} className="w-full justify-start px-3 py-2 text-left">
                      <Pencil size={16} />Editar
                    </Button>
                    <Button type="button" variant="ghost" onClick={() => void onEliminar(trabajo)} aria-label={`Eliminar ${trabajo.puesto}`} className="w-full justify-start px-3 py-2 text-left text-red-600 hover:bg-red-50 hover:text-red-700">
