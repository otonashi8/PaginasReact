...
import { ContactoCrudPanel } from './contacto/ContactoCrudPanel';
import { isSistemaContactoAccess, isSistemaEnvioAccess, isSistemaRedesAccess } from './sistemaModuleMatcher';
...
export const SistemaCrudPanel = ({ access }: SistemaCrudPanelProps) => {
  ...
  const esModuloContacto =
    isSistemaContactoAccess(accessName, accessLabelNormalized, access.path);
