                  ...
                  cuponesFiltrados.map((cupon) => (
                    <tr key={cupon.id} className="border-t border-zinc-200 hover:bg-zinc-50">
                      ...
                      <td className="px-4 py-3 text-right">
                        <TablaAcciones>
                          <button onClick={() => abrirEdicion(cupon)} className="block w-full px-3 py-2 text-left text-sm font-medium text-zinc-700 transition hover:bg-zinc-100">Editar</button>
                          <button onClick={() => eliminar(cupon.id)} className="block w-full px-3 py-2 text-left text-sm font-medium text-red-600 transition hover:bg-red-50">Eliminar</button>
                        </TablaAcciones>
                      </td>
                    </tr>
                  ))
