...
import {CreditCard,MessageCircle,Package,Phone,Send,Trash2,Truck,X,} from 'lucide-react';
import ChatMessage from './ChatMessage';
import { chatbotResponses, type ChatMessage as ChatMessageType } from './chatbotResponses';
import { useAuth } from '../../context/AuthContext';
import { obtenerEnlaceWhatsApp, useContacto } from '../../admin/Sistema/contacto/contactoService';
  ...
  const handleQuickResponse = (type: string) => {
    switch (type) {
      ...
      case 'payment':
        ...
        break;
      case 'advisor':
        window.open(obtenerEnlaceWhatsApp(contacto.whatsapp), '_blank', 'noopener,noreferrer');
        break;
      default:
        break;
    }
        ...
        {isOpen && (
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-2 border-t border-white/10 p-3 sm:grid-cols-2">
              ...
              <a
                href={obtenerEnlaceWhatsApp(contacto.whatsapp)}
                target="_blank"
