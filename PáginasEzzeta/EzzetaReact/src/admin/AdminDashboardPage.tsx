...
import { CuponesAnalyticsPanel } from './Ventas/cupones/CuponesAnalyticsPanel';
...
const getModulePanel = (module: PermissionModule | null, access: PermissionAccess) => {
  ...
  if (normalized === 'ventas' && accessLabel === 'cupones') {
    return <CuponesAnalyticsPanel key={access.path ?? access.id} />;
  }
