...
export default function CartSummary({
  ...
  return (
    <>
      <div className="mt-2 space-y-5 border-t border-black/10">
            ...
            {expandido ? (
              ...
              >
                <div className="space-y-3 pt-4">
                  ...
                  {shippingNotConfigured ? (
                    <p className="text-sm text-orange-600">Selecciona un departamento con tarifa configurada para calcular el envío.</p>
                  ) : null}
                </div>
              </motion.div>
            ) : null}
