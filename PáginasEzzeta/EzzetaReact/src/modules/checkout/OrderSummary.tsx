...
export function OrderSummary({
  ...
  const envio = Number(checkoutTotal ?? 0) - subtotal;

  return (
    <aside className="rounded-[30px] border border-[rgba(125,36,56,0.12)] bg-[#fffaf7] p-5 shadow-[0_22px_70px_rgba(91,31,38,0.08)]">
      ...
      <div className="mt-5 rounded-2xl border border-[rgba(125,36,56,0.08)] bg-white p-4">
        <div className="flex gap-2">
          <input
            ...
            className="h-11 flex-1 rounded-xl border border-[rgba(125,36,56,0.16)] bg-[#fffaf7] px-3 text-sm outline-none focus:border-vino"
          />
          <Button onClick={onApplyCoupon} className="h-11 rounded-xl px-3">Aplicar</Button>
        </div>
      ...
      <div className="mt-5 rounded-2xl bg-[rgba(255, 255, 255, 0.1)] p-4">
      ...
      <Button onClick={onConfirm} disabled={!canConfirm || confirmingOrder} className="mt-5 h-12 w-full rounded-full bg-vino text-crema hover:bg-vino-oscuro disabled:cursor-not-allowed disabled:opacity-60">
      ...
      <div className="mt-4 flex items-center gap-2 rounded-xl border border-[rgba(125,36,56,0.08)] bg-white p-3 text-xs text-[#7a5560]">
