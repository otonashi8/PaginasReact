      ...
      >
          ...
          >
              ...
              <div className="absolute inset-x-0 bottom-0 p-5 sm:p-8 lg:max-w-2xl">
                  ...
                  <p className="mt-3 max-w-xl text-sm leading-5 text-white/75 sm:text-sm">Diseño, calidad y operación integrada para construir una experiencia de moda constante.</p>
              </div>
          </motion.div>
          <motion.div
              variants={{
          ...
          >
              <div className="marquee-track flex w-max gap-5 px-2 text-[10px] font-medium uppercase tracking-[0.18em] text-zinc-500 sm:text-sm">
          ...
          <div className="grid gap-4 lg:grid-cols-[1.05fr_0.95fr]">
              ...
              >
                  <span className="text-[14px] font-semibold uppercase tracking-[0.2em] text-zinc-500">Ezzeta</span>
                  <h2 className="mt-2 text-xl font-semibold uppercase tracking-[0.08em] text-zinc-950 sm:text-2xl">Identidad de marca</h2>
                  <div className="mt-4 space-y-3 text-md leading-6 text-zinc-600">
                  ...
                  <div className="mt-5 grid grid-cols-2 gap-2 border-t border-zinc-100 pt-4">
                      <div>
                          ...
                          <p className="mt-1 text-[14px] uppercase tracking-[0.12em] text-zinc-500">Diseño</p>
                      </div>
                      <div>
                          <p className="text-lg font-semibold text-zinc-950">02</p>
                          <p className="mt-1 text-[14px] uppercase tracking-[0.12em] text-zinc-500">Distribución</p>
                      </div>
                  </div>
              </motion.div>
          </div>
              ...
              {[
                  ...
                  >
                      <div className="flex items-center justify-between">
                          <span className="text-[14px] font-semibold tracking-[0.15em] text-red-600">0{index + 1}</span>
                          <span className="h-px w-8 bg-zinc-200 transition-all duration-300 group-hover:w-14 group-hover:bg-red-600" />
                      </div>
                      <h3 className="mt-4 text-md font-semibold uppercase tracking-[0.08em] text-zinc-950">{item.title}</h3>
                      <p className="mt-2 text-md leading-5 text-zinc-600">{item.description}</p>
                  </motion.article>
              ))}
          </div>
          <motion.div
          ...
          >
              <div className="flex flex-col gap-3 border-b border-zinc-100 pb-4 sm:flex-row sm:items-end sm:justify-between">
                  <div>
                      <span className="text-[14px] font-medium uppercase tracking-[0.18em] text-zinc-500">Disponibilidad continua</span>
                      <h2 className="mt-1 text-md font-semibold uppercase tracking-[0.08em] text-zinc-950 sm:text-base">Stock permanente</h2>
                  </div>
                  <p className="max-w-2xl text-md leading-5 text-zinc-600 sm:text-right">Mantenemos disponibilidad continua en líneas clave para responder de forma inmediata a campañas, reposiciones y picos de demanda.</p>
              </div>
                  ...
                  {[
                      ...
                      <motion.article
                          ...
                          variants={{
                              ...
                              visible: { opacity: 1, y: 0, transition: { duration: 0.35, delay: index * 0.08, },},
                          }}
                          whileHover={{ y: -3 }}
                      ...
                      >
                          <div className="flex items-center justify-between">
                              <span className="text-md font-semibold tracking-[0.15em] text-zinc-400">0{index + 1}</span>
                              <span className="h-px w-6 bg-zinc-200 transition-all duration-300 group-hover:w-10 group-hover:bg-red-600" />
                          </div>
                          <h3 className="mt-4 text-md font-semibold uppercase tracking-[0.08em] text-zinc-950">{item.title}</h3>
                          <p className="mt-1.5 text-md leading-5 text-zinc-600">{item.description}</p>
                      </motion.article>
                  ))}
              </div>
          </motion.div>
          ...
          >
              <div className="flex items-end justify-between gap-3 border-b border-zinc-100 pb-4">
                  <div>
                      <span className="text-sm font-medium uppercase tracking-[0.18em] text-zinc-500">Nuestra operación</span>
                      <h2 className="mt-1 text-md font-semibold uppercase tracking-[0.08em] text-zinc-950 sm:text-base">Nuestras instalaciones</h2>
                  </div>
                  <span className="text-md uppercase tracking-[0.12em] text-zinc-400">03 espacios</span>
              </div>
                  ...
                  {[
                      ...
                      >
                          <img
                              src={image.src}
                              alt={image.alt}
                              className="h-60 w-full object-cover transition duration-700 group-hover:scale-[1.05] sm:h-90"
                          />
                          <div className="absolute inset-x-0 bottom-0 translate-y-full bg-gradient-to-t from-black/70 to-transparent px-4 pb-3 pt-10 transition duration-300 group-hover:translate-y-0">
                              <p className="text-md font-medium uppercase tracking-[0.15em] text-white">{image.alt}</p>
                          </div>
                      </motion.div>
                  ))}
              </div>
          ...
          >
              <div className="flex flex-col gap-4 border-b border-zinc-100 pb-4 sm:flex-row sm:items-center">
                  ...
                  <div>
                      ...
                      <p className="mt-2 max-w-2xl text-sm leading-5 text-zinc-600 sm:text-sm">Un referente de estilo que impulsa una visión clara y cercana del dressing masculino.</p>
                  </div>
              </div>
              <div className="mt-4 overflow-hidden border border-zinc-200 bg-white p-1.5">
                  <div className="aspect-video w-full overflow-hidden bg-zinc-100">
                      <iframe
                          src="https://www.youtube.com/embed/rzjMb3FN0sm?rel=0&modestbranding=1"
