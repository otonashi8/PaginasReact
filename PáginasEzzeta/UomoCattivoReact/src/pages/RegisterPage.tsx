      ...
      <div className="w-full max-w-2xl rounded-3xl border border-black/10 bg-white p-8 shadow-sm">
        ...
        <form className="grid gap-4 md:grid-cols-2" onSubmit={handleSubmit}>
          <div>
            ...
            <input id="username" name="username" value={form.username} onChange={handleChange} className="w-full rounded-full border border-black/15 bg-[#F7F3EC] px-4 py-3 text-sm text-black outline-none transition focus:border-black" placeholder="Tu usuario" required />
          </div>

          <div>
            <label className="mb-1 block text-sm font-medium text-black" htmlFor="email">Correo</label>
            <input id="email" name="email" type="email" value={form.email} onChange={handleChange} className="w-full rounded-full border border-black/15 bg-[#F7F3EC] px-4 py-3 text-sm text-black outline-none transition focus:border-black" placeholder="correo@empresa.com" required />
          </div>

          <div>
            <label className="mb-1 block text-sm font-medium text-black" htmlFor="password">Contraseña</label>
            <input id="password" name="password" type="password" value={form.password} onChange={handleChange} className="w-full rounded-full border border-black/15 bg-[#F7F3EC] px-4 py-3 text-sm text-black outline-none transition focus:border-black" placeholder="••••••••" required />
          </div>

          <div>
            <label className="mb-1 block text-sm font-medium text-black" htmlFor="phone">Teléfono</label>
            <input id="phone" name="phone" value={form.phone} onChange={handleChange} className="w-full rounded-full border border-black/15 bg-[#F7F3EC] px-4 py-3 text-sm text-black outline-none transition focus:border-black" placeholder="987654321" required />
          </div>

          <div>
            <label className="mb-1 block text-sm font-medium text-black" htmlFor="ruc">RUC (opcional)</label>
            <input id="ruc" name="ruc" value={form.ruc} onChange={handleChange} className="w-full rounded-full border border-black/15 bg-[#F7F3EC] px-4 py-3 text-sm text-black outline-none transition focus:border-black" placeholder="20600000000" />
          </div>

          <div>
            <label className="mb-1 block text-sm font-medium text-black" htmlFor="plan">Plan</label>
            <select id="plan" name="plan" value={form.plan} onChange={handleChange} className="w-full rounded-full border border-black/15 bg-[#F7F3EC] px-4 py-3 text-sm text-black outline-none transition focus:border-black">
          ...
          <div className="md:col-span-2 rounded-2xl border border-black/10 bg-[#F7F3EC] p-4 text-sm text-black/80">
          ...
          <div className="md:col-span-2">
            ...
            <select id="autoRenew" name="autoRenew" value={String(form.autoRenew)} onChange={handleChange} className="w-full rounded-full border border-black/15 bg-[#F7F3EC] px-4 py-3 text-sm text-black outline-none transition focus:border-black">
