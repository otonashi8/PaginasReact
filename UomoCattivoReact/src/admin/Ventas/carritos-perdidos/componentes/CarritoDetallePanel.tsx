                ...
                <div className="flex items-center justify-between border-b px-6 py-4">
                    ...
                    <div className="flex items-center gap-2">
                        <button
                            ...
                            className="inline-flex items-center gap-2 rounded-lg border border-zinc-300 bg-bone px-4 py-2 text-sm text-zinc-700 transition hover:bg-zinc-100"
                        >
                        ...
                        <button
                            ...
                            className="inline-flex items-center gap-2 rounded-lg border border-emerald-300 bg-bone px-4 py-2 text-sm text-emerald-700 transition hover:bg-emerald-50"
                        >
                        ...
                        <button
                            ...
                            className="inline-flex items-center gap-2 rounded-lg border border-red-300 bg-bone px-4 py-2 text-sm text-red-600 transition hover:bg-red-50"
                        >
                        ...
                        <button
                            type="button"
                            onClick={cerrar}
                            className="rounded-lg border border-zinc-300 bg-bone px-4 py-2 text-sm text-zinc-700 transition hover:bg-zinc-100"
                        >Cerrar</button>
                    </div>
                </div>
