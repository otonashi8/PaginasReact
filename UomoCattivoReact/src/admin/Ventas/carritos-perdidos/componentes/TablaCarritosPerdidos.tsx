...
export const TablaCarritosPerdidos = ({
    ...
    return (
        <div className="space-y-4">
            ...
            <div className="flex flex-col gap-3 rounded-none border border-zinc-200 bg-bone p-5 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div className="flex items-center gap-2">
                    <button
                        ...
                        className="rounded-none border border-zinc-300 bg-bone px-4 py-2 text-sm transition hover:bg-zinc-100 disabled:cursor-not-allowed disabled:opacity-50"
                    >Anterior</button>
                    <button
                        type="button"
